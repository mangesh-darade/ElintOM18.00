...
<div class="box">
    <div class="box-content">
        <div class="cms-back-header">
            ...
            <h1 class="cms-page-title"><i class="fa fa-tags"></i> Entity Tag Mapping / Edit</h1>
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="entity_master_id" id="entity_master_id" class="form-control">
                                ...
                                <?php foreach ($entity_types as $type) { ?>
                                    <option value="<?= (int) $type['id']; ?>" <?= ((int) $type['id'] === (int) $mapping['entity_master_id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="col-md-2">
                        <div class="form-group" style="margin-top:24px;">
                            <button type="submit" name="update_mapping" value="1" class="btn btn-info btn-block">Save Tag Values</button>
                        </div>
                    </div>
                </div>
            </div>
