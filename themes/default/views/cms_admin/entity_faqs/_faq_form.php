...
<div class="alert alert-warning">FAQ table is not ready. Save once to create <code>sma_cms_entity_faqs</code> automatically.</div>
<?php } ?>
<p class="cms-panel-desc cms-pe-collapsible__intro">
    Each row is stored with <strong>Entity Type</strong>, <strong>Entity Id</strong>, <strong>Category</strong>, <strong>Question</strong>, and <strong>Answer</strong>
    in <code>sma_cms_entity_faqs</code>. Rows with an empty question are ignored on save.
</p>
