...
$mapping = isset($mapping) && is_array($mapping) ? $mapping : array();
?>
<div class="box">
    <div class="box-content">
        <?= form_open(current_url(), array('id' => 'entityFaqForm')); ?>
        ...
        <div class="cms-collapsible-panel" id="cmsEntityFaqsCollapsible">
            <div class="cms-collapsible-header-row">
                ...
                <div class="cms-collapsible-header-actions">
                    ...
                    <button type="submit" name="update_entity_faqs" value="1" class="btn btn-primary btn-sm">
