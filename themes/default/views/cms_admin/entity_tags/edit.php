...
<?php
/**
 * Entity Tag Mapping — Edit Existing
...
// Pre-populate existing tag values for edit mode
$existing_rows   = isset($mapping['rows']) ? $mapping['rows'] : array();
...
<div class="box">
    <div class="box-content">
        <?= form_open(current_url(), array('id' => 'entityMapForm')); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="entity_master_id" id="entity_master_id" class="form-control cms-native-select">
                                ...
                                ?>
                                    <option value="<?= (int) $type['id']; ?>" data-code="<?= htmlspecialchars($type_code, ENT_QUOTES, 'UTF-8'); ?>" <?= ((int) $type['id'] === (int) $mapping['entity_master_id']) ? 'selected' : ''; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <select name="entity_id" id="entity_id" class="form-control cms-native-select">
                                ...
                                <?php foreach ($entity_items as $item) { ?>
                                    <option value="<?= (int) $item['id']; ?>" <?= ((int) $item['id'] === (int) $mapping['entity_id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="col-md-2">
                        <div class="form-group" style="margin-top:24px;">
                            <button type="submit" name="update_mapping" value="1" class="btn btn-info btn-block">Save Tag Values &amp; FAQs</button>
                        </div>
                    </div>
                </div>
        ...
        <?php $this->load->view('default/views/cms_admin/entity_tags/_tag_form', array(
            ...
            'head_tag_import_url'  => site_url('cms_admin/entity_tags/ajax_import_head_tags/' . (int) $mapping['entity_master_id'] . '/' . (int) $mapping['entity_id']),
        )); ?>
        </div>
