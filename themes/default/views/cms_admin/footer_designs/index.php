...
<div class="cms-header-designs-page cms-hd-index cms-fd-index">
    ...
    <div class="cms-page-toolbar cms-header-designs-toolbar">
        ...
        <a class="cms-btn-primary btn-add-cms" href="<?= site_url('cms_admin/footer_designs/create'); ?>">

            <i class="fa fa-plus"></i> New footer design
    ...
    <p class="cms-header-designs-intro">
        Each card is one footer layout. Customize to add copyright, links, columns — then attach to a page (step 3 in the guide).
    </p>
    ...
    <div class="cms-header-designs-grid">
        ...
        <?php if (!empty($profiles)) { ?>
            ...
            <?php foreach ($profiles as $p) {
                ...
                $prev_url = site_url('cms_admin/footer_designs/preview/' . rawurlencode($slug) . '?compact=1&t=' . time());
                ...
                <article class="cms-header-design-card">
                    ...
                    <div class="cms-header-design-card__preview">
                        ...
                        <a class="cms-header-design-card__preview-link" href="<?= site_url('cms_admin/footer_designs/preview/' . rawurlencode($slug)); ?>" target="_blank" rel="noopener" title="Full preview">
                    ...
                    <div class="cms-header-design-card__body">
                        ...
                        <div class="cms-header-design-card__actions">
                            ...
                            <a class="btn btn-primary btn-sm" href="<?= site_url('cms_admin/footer_designs/edit/' . rawurlencode($slug)); ?>">

                                <i class="fa fa-pencil"></i> Customize

                            </a>

                            <a class="btn btn-default btn-sm" href="<?= site_url('cms_admin/footer_designs/preview/' . rawurlencode($slug)); ?>" target="_blank" rel="noopener">
                            ...
                            <a class="btn btn-danger btn-sm" href="<?= site_url('cms_admin/footer_designs/delete_profile/' . rawurlencode($slug)); ?>"

                               onclick="return confirm('Delete this footer design and all its items?');">
        ...
        <?php } else { ?>
            ...
            <div class="cms-header-designs-empty">
                ...
                <p>No footer designs yet.</p>

                <a class="cms-btn-primary btn-add-cms" href="<?= site_url('cms_admin/footer_designs/create'); ?>">Create first design</a>
