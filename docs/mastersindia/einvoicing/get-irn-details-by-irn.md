> For the complete documentation index, see [llms.txt](https://docs.mastersindia.co/einvoicing/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.mastersindia.co/einvoicing/get-irn-details-by-irn.md).
...
| --------- | ---------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| gstin     | XXXXXXXXXXXXXXX                                                  | GSTIN of the authenticated user                                              |
...
```json
{
  "results": {
    "message": "",
    "errorMessage": "2148: Requested IRN data is not available",
    "InfoDtls": "",
    "status": "Failed",
    "code": 204
  }
